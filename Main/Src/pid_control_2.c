...
CSYS_Handle Foot_Angle_Control(CSYS_Handle *CSYS)
{
	switch(CSYS->ID)
	{
		case 1:
		{
			CSYS->RM3508_1->Infer_Real_Angle = 157.8f+(79.8f-CSYS_Foot[0].Infer_theta1);
			CSYS->RM3508_2->Infer_Real_Angle = (79.8f + CSYS_Foot[0].Infer_theta2);
			break;
		}
		case 2:
		{
			CSYS->RM3508_1->Infer_Real_Angle = -157.8f-(79.8f-CSYS_Foot[1].Infer_theta1);
			CSYS->RM3508_2->Infer_Real_Angle = -(79.8f + CSYS_Foot[1].Infer_theta2);
			break;
		}
		case 3:
		{
			CSYS->RM3508_1->Infer_Real_Angle = (83.0f - CSYS_Foot[2].Infer_theta1);
			CSYS->RM3508_2->Infer_Real_Angle = 154.6f + (79.8f + CSYS_Foot[2].Infer_theta2);
			break;
		}
		case 4:
		{
			CSYS->RM3508_1->Infer_Real_Angle = -(83.0f-CSYS_Foot[3].Infer_theta1);
			CSYS->RM3508_2->Infer_Real_Angle = -154.6f - (79.8f + CSYS_Foot[3].Infer_theta2);
			break;
		}
	}
	return *CSYS;
